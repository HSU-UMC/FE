    ...
    feel: [
      {
        ...
        part: "DESIGN",
        explain:
          "프로젝트에서 디자이너 역할을 맡았습니다. 앱 디자인은 처음이라 선택과 집중을 하였는데 사용자가 사용하는데 불편함을 느끼지 않도록 집중하며 디자인을 하였습니다. 그래서 사용자가 서비스를 이용하는데 있어서 익숙한 환경이 무엇인지, 시각적으로 불편함이 없는지를 고민하며 디자인하였습니다. 또한 PM님이 열심히 완성한 기획을 의도한대로 결과물이 나오는 것에도 집중하였습니다.\n프로젝트를 진행하면서 기획자, 개발자와 협업을 할 수 있었던 계기가 되었으며, 그 과정에서 어떻게 소통을 해야할지 배울 수 있었습니다. 그리고 진로를 UI/UX 디자이너로 갈지 고민하였는데 그 고민을 결정하는 데, 도움이 되었습니다.",
      },
      {
        id: 2,
        nickname: "미니",
      ...
      },
      {
        ...
        part: "ANDROID",
        explain:
          "안드로이드 화면 설계 및 API 연결, 내부 기능을 담당했습니다.\n너무 즐거운 프로젝트였고, 기초를 더 탄탄하게 할 수 있었습니다. 무엇보다도 협업 능력을 기를 수 있고, 프로젝트 기간도 여유로워 다양한 기술 스택을 배울 수 있었습니다. 기초를 탄탄하게 다져나가고 싶거나, 처음부터 제대로 배워보고 싶었는데 모두 이룬 것 같아 200% 만족했습니다!",
      },
      {
        id: 4,
        nickname: "빈트",
        ...
        part: "SPRINGBOOT",
        explain:
          "백 스프링부트 헤더로써 프로젝트를 진행했습니다.\n많은 인원과 함께하는 프로젝트 진행이여서 매우 새롭고 재밌었습니다. 팀원분들이 다 잘 따라와주셔서 매우 원활히 진행 할수 있었습니다. 매우 좋은 기회였습니다!",
      },
    ],
    subTitle: [
      {
    ...
    feel: [
      {
        ...
        part: "PLAN",
        explain:
          "PM으로써 서비스를 기획하고, 프로젝트 과정과 팀원들의 일정 등 전반적인 제작 과정을 총괄하였으며, 간단한 디자인 및 비용 관리, 데모데이 부스 준비 등의 활동을 하였습니다.\n처음 해보는 역할이어서 어려운 점이 많았지만 그만큼 배운 것도 많았던 활동이었던 것 같습니다.",
      },
      {
        id: 2,
        nickname: "칼트",
        ...
        part: "ANDROID",
        explain:
          "UI 구성 및 API 연결을 하였습니다.\n처음해보는 활동이지만 너무 뜻 깊었고 많은 것을 배워갈 수 있는 활동이었다고 생각합니다!!",
      },
    ],
    subTitle: [
      {
    ...
    feel: [
      {
        ...
        part: "PLAN",
        explain:
          "서비스 기획 및 디자인 공동작업, 각 팀원의 의견 전달 및 진도 확인 후 일정 계획을 했습니다.\n기획자로 처음 참여한 프로젝트, 기획자는 기획만 끝내면 되는 것이 아닌 팀 전체를 이끌어가며 자신이 생각한 방향으로 프로젝트가 잘 진행될 수 있게 조율해야 하기 때문에 책임감을 가져야 한다고 느꼈습니다.",
      },
      {
        id: 2,
        nickname: "비니",
    ...
    feel: [
      {
        ...
        part: "DESIGN",
        explain:
          "비건을 본인만의 라이프스타일로 만들고 싶은 MZ세대가 주요 타겟임을 고려하여, UI 디자인을 세련되고 트렌디하게 함으로써 더욱 비건을 시도해볼 수 있도록 디자인하였습니다. 자신만의 비건 레시피를 공유하고 만들어 볼 수 있어, 더욱 감성적으로 접근했습니다.\n좋은 팀원분들을 만나, 디자인 화면들을 실제로 구현해볼 수 있어 뜻깊은 활동이였습니다.",
      },
      {
        id: 2,
        nickname: "라이덜",
        ...
        part: "NODE.JS",
        explain:
          "Node.js(서버) 파트원으로 어플리케이션 서비스를 위한 데이터베이스 설계, 구축과 API 설계 및 서버 기능을 구현하였습니다.\n이번 프로젝트는 처음으로 참여한 팀 프로젝트였고 때문에 팀원들과 함께 어플리케이션을 기획하고 개발, 출시하는 과정을 경험할 수 있었습니다. 처음엔 node.js를 사용한 서버개발이 처음이었기 때문에 어려움이 있었지만, 프로젝트를 진행하며 백엔드 개발의 기본적인 개념과 원리를 익힐 수 있었습니다. 데이터베이스의 설계, 구축, 연동, API 개발, 서버 기능 구현 등 다양한 영역에서 많은 것을 배웠습니다. 또한 팀원들과의 협업을 통해 문제를 해결해 나가는 과정에서 커뮤니케이션의 중요성을 실감하게 되었습니다. 각자의 생각과 아이디어를 공유하고 조율하면서 프로젝트를 성공적으로 마칠 수 있었고, 이는 앞으로의 개발자로서의 진로로 나아가는데 큰 도움이 될 것이라고 확신합니다.",
      },
    ],
    subTitle: [
      {
    ...
    feel: [
      {
        ...
        part: "DESIGN",
        explain:
          "전체적인 앱 디자인 및 데모데이 굿즈 디자인을 하였습니다.\n디자인 완성도가 높게 나와서 만족했습니다!",
      },
      {
        id: 2,
        nickname: "하키",
        ...
        part: "IOS",
        explain:
          "대학원 커뮤니티 서비스 석박지에서 게시판 파트와 디렉토리 파트를 맡아 UI/UX 개발 및 여러 버튼의 기능 구현과 백엔드 서버에서 구현된 API들을 프론트 개발과 연동했습니다.\n다양한 사람들과 협업을 진행하면서 나눠진 파트에 따라 개발을 해볼 수 있는 좋은 경험이 될 수 있었습니다. 처음 해보는 협업 프로젝트인데, 팀원들 중 누구의 탈주도 없이 끝까지 노력하여 결과물을 발표할 수 있을 때 굉장한 성취감을 느낄 수 있었습니다. 이번 UMC 6기 활동을 하면서 스터디 진행을 위해 스스로 워크북을 채우는 과정에서도 스스로 정보를 수집하고 이해하는 부분에서 한 단계 더 성장할 수 있었습니다. 또한, 어떻게 해야할지 모르는 나로서, 데모데이 프로젝트를 직접 해보고 나니, 자신감도 생기게 되었고 앞으로도 더 많은 프로젝트를 해보고 싶다는 생각이 들었습니다. 단순히 기초 지식과 개념만 가지고 시작해서 ‘과연 내가 프로젝트를 할 수 있을까?’라는 걱정을 많이 했었지만, 직접 해보면서 배우기도 하고 스스로 공부하게 되는 좋은 영향 덕분에 잘 마무리 할 수 있었습니다.",
      },
      {
        id: 3,
        nickname: "레이첼",
        ...
        part: "SPRINGBOOT",
        explain:
          "석박지(석사 박사 지원부터 취업정보까지)의 서버 파트로 참여하게 되었는데 이번에 처음 스프링부트를 접하고 하게 된 프로젝트입니다. 아직 부족한데 잘 할 수 있을까 걱정이 많이 됐었는데 좋은 팀원들을 만나서 서로에게 도움이 되기도 하고, 기대했던 결과물을 만들어낼 수 있어서 행복했어요! 저번 기수 iOS 파트에 이어 이번 6기 UMC에도 활동하게 되었는데, 매주 스터디를 통해 역량을 기르면서 공부할 수 있는 시간을 가질 수 있다는 게 좋았어요. 그리고 기획, 디자인, 프론트엔드, 백엔드 다양한 파트가 모여 약 두달간 개발을 진행하여 완성도 있는 프로젝트를 경험해볼 수 있는데요. 데모데이까지 거치게 되면 정말 많이 배우고 성장해있는 모습을 발견하실 수 있을 거예요!",
      },
    ],
    subTitle: [
      {
