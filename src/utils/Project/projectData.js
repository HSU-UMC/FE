    ...
    { 
        ...
        "feel": [
            ...
            },
            {
                ...
                "name": "윤상혁",
                "part": "WEB",
                "explain": "다른 파트 사람들과 처음으로 협업하며 개발했던 프로젝트였습니다. 처음이다보니 모르는 점이 많아서 UI 구현과 API 연결에 막혔던 부분이 몇 있었지만, 다양한 파트의 사람들과 협업하고 소통하는 방식과 피그마 디자인을 토대로 직접 코드에 적용하는 법 등을 배울 수 있었습니다. 어떤 수업, 스터디보다 얻어가는 게 많았던 시간이었다고 생각합니다. 재미있었습니다~"
            }
        ],
        "subTitle": [
            {
